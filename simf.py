...
name.text = "Fidele Симферополь"
shop.append(name)

company = ET.Element("company")
company_text = 'Доставка еды Fidele Симферополь'
company.text = company_text
shop.append(company)

url = ET.Element("url")
url_text = "https://fidele-food.ru/simf"
url.text = url_text
shop.append(url)
...
if __name__ == "__main__":
    ...
    target_url = "https://fidele-food.ru/simf"
