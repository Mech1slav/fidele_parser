...
name.text = "Fidele Севастополь"
shop.append(name)

company = ET.Element("company")
company_text = 'Доставка еды Fidele Севастополь'
company.text = company_text
shop.append(company)

url = ET.Element("url")
url_text = "https://fidele-food.ru/sevastopol"
url.text = url_text
shop.append(url)
...
if __name__ == "__main__":
    ...
    target_url = "https://fidele-food.ru/sevastopol"
